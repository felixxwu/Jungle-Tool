...
import type { Layer, LoadedFile } from './types'
...
export const Arrangement = singletonState<{ stepNumToPlay: number; startStep: number }[]>([
  ...
  { stepNumToPlay: 4, startStep: 10 },
  { stepNumToPlay: 5, startStep: 11 },
  { stepNumToPlay: 6, startStep: 12 },
  { stepNumToPlay: 7, startStep: 13 },
  { stepNumToPlay: 8, startStep: 14 },
  { stepNumToPlay: 9, startStep: 15 },
])
